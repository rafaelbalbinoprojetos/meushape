...
export const SAMPLE_COACH_PROMPTS = [
  ...
  "Crie um treino personalizado usando minhas medidas e evolução (peso, circunferências, IMC) e indique o objetivo.",
  "Crie uma dieta personalizada usando minhas medidas e evolução (peso, circunferências, IMC) e indique macros e refeições.",
];
